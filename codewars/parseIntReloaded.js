...
function parseInt2(string) {
  ...
  const parsed = (strArr) => {
    return strArr.reduce((acc, word, i, words) => {
      ...
      switch (word) {
        case "thousand":
          //console.log("spliced", parsed(words.splice(i + 1)));
...
console.log(parseInt2("one")); //=> 1
console.log(parseInt2("twenty")); //> 20
console.log(parseInt2("two hundred forty-six")); //=> 246
console.log(
  parseInt2("seven hundred eighty-three thousand nine hundred and nineteen")
); //=> 783919
